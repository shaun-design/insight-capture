      ...
      <div className="mb-8 flex items-start justify-between gap-4">
        <div className="max-w-2xl">
          ...
          <p className="mt-1.5 text-sm text-muted-foreground">
            Create and manage structured forms for collecting information across
            Maplewood Academy — from classroom observations and behavior logs to
            grant documentation and coaching notes.
          </p>
        </div>
