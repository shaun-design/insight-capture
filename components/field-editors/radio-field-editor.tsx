...
export function createDefaultRadioSettings(): RadioFieldSettings {
  return {
    prompt: "",
    options: [
...
function SortableOption({
  ...
  option: RadioOption;
  onUpdate: (id: string, field: keyof RadioOption, value: string) => void;
...
export function RadioFieldEditor({
  ...
  isActive?: boolean;
  value: RadioFieldSettings;
  onChange: (next: RadioFieldSettings) => void;
}) {
  ...
  function updateOption(id: string, field: keyof RadioOption, value: string) {
    onChange({
      ...settings,
  ...
  function set<K extends keyof RadioFieldSettings>(key: K, value: RadioFieldSettings[K]) {
